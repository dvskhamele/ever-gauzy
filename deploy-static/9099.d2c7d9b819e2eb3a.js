"use strict";
(self["webpackChunkgauzy"] = self["webpackChunkgauzy"] || []).push([[9099],{

/***/ 5620:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   I: () => (/* binding */ LineChartComponent)
/* harmony export */ });
...
/* harmony import */ var ng2_charts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(80250);
/* harmony import */ var chartjs_plugin_annotation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(55816);
...
/* harmony import */ var _chart_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(35476);
...
let LineChartComponent = /*#__PURE__*/(() => {
  let LineChartComponent = class LineChartComponent extends _gauzy_ui_core_i18n__WEBPACK_IMPORTED_MODULE_0__/* .TranslationBaseComponent */ .K {
    /**
    ...
    constructor(themeService, translate) {
       ...
       */
      this.standardWorkHours = _gauzy_constants__WEBPACK_IMPORTED_MODULE_1__/* .DEFAULT_STANDARD_WORK_HOURS_PER_DAY */ .bO;
      /**
      ...
      chart_js__WEBPACK_IMPORTED_MODULE_2__/* .Chart */ .t1.register(
      // Controllers
      chart_js__WEBPACK_IMPORTED_MODULE_2__/* .LineController */ .ZT,
      // Scales
      chart_js__WEBPACK_IMPORTED_MODULE_2__/* .CategoryScale */ .PP, chart_js__WEBPACK_IMPORTED_MODULE_2__/* .LinearScale */ .kc,
      // Elements
      chart_js__WEBPACK_IMPORTED_MODULE_2__/* .PointElement */ .FN, chart_js__WEBPACK_IMPORTED_MODULE_2__/* .LineElement */ .No,
      // Plugins
      chartjs_plugin_annotation__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A);
    }
    ngOnInit() {
      this.themeService.getJsTheme().pipe(
      // Tap into the stream to execute a side effect (initialize the chart)
      (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__/* .tap */ .M)(config => this.initializeChart(config)),
    ...
    getAnnotationConfig() {
      ...
      const standardWorkHours = this.standardWorkHours || _gauzy_constants__WEBPACK_IMPORTED_MODULE_1__/* .DEFAULT_STANDARD_WORK_HOURS_PER_DAY */ .bO;
      const labelContent = this.getTranslation('REPORT_PAGE.STANDARD_WORK_HOURS', {
        hours: standardWorkHours
      });
        ...
        annotations: {
          line1: {
            ...
            label: {
              ...
              position: 'end',
              // Moves the label below the line (adjust as needed)
              yAdjust: 15,
              // Moves the label down by 15px (adjust as needed)
    ...
    initializeChart(config) {
      ...
      this.lineChartOptions = {
        ...
        // Allows adjusting the aspect ratio
        plugins: {
          ...
          ...(instance.enableAnnotations ? {
            annotation: instance.getAnnotationConfig()
          } : {})
        },
        elements: {
    ...
    resetDatasetStyles(dataset) {
      ...
      dataset['backgroundColor'] = _chart_utils__WEBPACK_IMPORTED_MODULE_6__/* .ChartUtil */ .D.transparentize(dataset.backgroundColor, 1);
    }
    ...
    applyHoverStyles(activeDataset) {
      ...
      activeDataset['backgroundColor'] = _chart_utils__WEBPACK_IMPORTED_MODULE_6__/* .ChartUtil */ .D.transparentize(activeDataset.backgroundColor, 0.4);
    ...
    static {
      this.ɵfac = function LineChartComponent_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || LineChartComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵdirectiveInject"] */ .rXU(_nebular_theme__WEBPACK_IMPORTED_MODULE_8__/* .NbThemeService */ .NS1), _angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵdirectiveInject"] */ .rXU(_ngx_translate_core__WEBPACK_IMPORTED_MODULE_9__/* .TranslateService */ .c$));
      };
    }
    static {
      this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵdefineComponent"] */ .VBU({
        type: LineChartComponent,
        selectors: [["ngx-line-chart"]],
        viewQuery: function LineChartComponent_Query(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵviewQuery"] */ .GBs(ng2_charts__WEBPACK_IMPORTED_MODULE_10__/* .BaseChartDirective */ .j9, 5);
          }
          if (rf & 2) {
            let _t;
            _angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵqueryRefresh"] */ .mGM(_t = _angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵloadQuery"] */ .lsd()) && (ctx.baseChartDirective = _t.first);
          }
        },
        inputs: {
          enableAnnotations: "enableAnnotations",
        ...
        standalone: false,
        features: [_angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵInheritDefinitionFeature"] */ .Vt3, _angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵNgOnChangesFeature"] */ .OA$],
        decls: 2,
        vars: 4,
        consts: [[1, "chart"], ["baseChart", "", 3, "chartHover", "chartClick", "data", "options", "type", "legend"]],
        template: function LineChartComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵelementStart"] */ .j41(0, "div", 0)(1, "canvas", 1);
            _angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵlistener"] */ .bIt("chartHover", function LineChartComponent_Template_canvas_chartHover_1_listener($event) {
          ...
          if (rf & 2) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵproperty"] */ .Y8G("data", ctx.data)("options", ctx.lineChartOptions)("type", ctx.lineChartType)("legend", ctx.lineChartLegend);
          }
        },
        dependencies: [ng2_charts__WEBPACK_IMPORTED_MODULE_10__/* .BaseChartDirective */ .j9],
        styles: ["[_nghost-%COMP%]   .chart[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 400px;\n  display: block;\n}"],
        changeDetection: 0
      });
    }
  };
  LineChartComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_11__/* .__decorate */ .Cg)([(0,_ngneat_until_destroy__WEBPACK_IMPORTED_MODULE_5__/* .UntilDestroy */ .d)({
    checkProperties: true
  }), (0,tslib__WEBPACK_IMPORTED_MODULE_11__/* .__metadata */ .Sn)("design:paramtypes", [_nebular_theme__WEBPACK_IMPORTED_MODULE_8__/* .NbThemeService */ .NS1, _ngx_translate_core__WEBPACK_IMPORTED_MODULE_9__/* .TranslateService */ .c$])], LineChartComponent);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   D: () => (/* binding */ ChartUtil)
/* harmony export */ });
...
class ChartUtil {
  ...
  static transparentize(value, opacity) {
    ...
    return (0,_kurkle_color__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Ay)(value).alpha(alpha).rgbString();
  }
  static {
    this.NAMED_COLORS = [ChartUtil.CHART_COLORS.red, ChartUtil.CHART_COLORS.orange, ChartUtil.CHART_COLORS.yellow, ChartUtil.CHART_COLORS.green, ChartUtil.CHART_COLORS.blue, ChartUtil.CHART_COLORS.purple, ChartUtil.CHART_COLORS.grey];
  }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ annotation)
/* harmony export */ });
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(75256);
/* harmony import */ var chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(79756);
/*!
...
function getNearestItem(visibleElements, event, options) {
  ...
  return filterElements(visibleElements, event, options).reduce((nearestItems, element) => {
    ...
    const distance = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.aF)(event, evenPoint);
...
function inLabelRange(point, {
  ...
  const rotPoint = rotated(point, center, (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.t)(-rotation));
...
function measureLabelRectangle(point, labelSize, {
  ...
  const hasPadding = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.i)(padding);
...
function toFonts(options, fitRatio) {
  ...
  const fonts = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.b)(optFont) ? optFont : [optFont];
  if (shouldFit(options, fitRatio)) {
    return fonts.map(function (f) {
      const font = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.a0)(f);
      font.size = Math.floor(f.size * fitRatio);
      font.lineHeight = f.lineHeight;
      return (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.a0)(font);
    });
  }
  return fonts.map(f => (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.a0)(f));
}
...
function execCallback(chart, properties, options) {
  const result = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.Q)(options.init, [{
    chart,
    properties,
    options
  }]);
...
function drawBox(ctx, rect, options) {
  ...
  ctx.beginPath();
  (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.aw)(ctx, {
    x,
    y,
    w: width,
    h: height,
    radius: clampAll((0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.ay)(options.borderRadius), 0, Math.min(width, height) / 2)
  });
  ctx.closePath();
  ctx.fill();
  if (stroke) {
...
function drawPoint(ctx, element, x, y) {
  ...
  let rad = (rotation || 0) * chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.b4;
...
function drawPointStyle(ctx, {
  ...
  switch (style) {
    ...
    case 'triangle':
      ...
      rad += chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.b6;
    ...
    case 'rectRounded':
      ...
      xOffset = Math.cos(rad + chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.b5) * size;
      yOffset = Math.sin(rad + chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.b5) * size;
...
function drawCallout(ctx, element) {
  ...
  const rotatedPoint = rotated({
    x: pointX,
    y: pointY
  }, element.getCenterPoint(), (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.t)(-element.rotation));
...
function resolveCalloutAutoPosition(element, options) {
  ...
  for (let index = 0; index < 4; index++) {
    const rotatedPoint = rotated({
      x: xPoints[index],
      y: yPoints[index]
    }, center, (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.t)(rotation));
    result.push({
      position: positions[index],
      distance: (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.aF)(rotatedPoint, {
        x: pointX,
        y: pointY
      })
    });
...
class BoxAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_1__/* .Element */ .Hg {
  inRange(mouseX, mouseY, axis, useFinalPosition) {
    const {
      ...
      x: mouseX,
      y: mouseY
    }, this.getCenterPoint(useFinalPosition), (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.t)(-this.options.rotation));
    return inBoxRange({
      x,
      y
...
class DoughnutLabelAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_1__/* .Element */ .Hg {
  inRange(mouseX, mouseY, axis, useFinalPosition) {
    return inLabelRange({
      x: mouseX,
      y: mouseY
...
function getDatasetMeta(chart, options) {
  return chart.getSortedVisibleDatasetMetas().reduce(function (result, value) {
    ...
    if (controller instanceof chart_js__WEBPACK_IMPORTED_MODULE_1__/* .DoughnutController */ .ju && isControllerVisible(chart, options, value.data) && (!result || controller.innerRadius < result.controller.innerRadius) && controller.options.circumference >= 90) {
      return value;
    }
    return result;
  }, undefined);
...
function getAngles(y, centerX, centerY, radius) {
  ...
  if (delta <= 0) {
    return {
      _startAngle: 0,
      _endAngle: chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.T
    };
  }
  const start = (-b - Math.sqrt(delta)) / 2;
  const end = (-b + Math.sqrt(delta)) / 2;
  return {
    _startAngle: (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.D)({
      x: centerX,
      y: centerY
    }, {
      x: start,
    ...
    _endAngle: (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.D)({
      x: centerX,
      y: centerY
    }, {
      x: end,
...
class LabelAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_1__/* .Element */ .Hg {
  inRange(mouseX, mouseY, axis, useFinalPosition) {
    return inLabelRange({
      x: mouseX,
      y: mouseY
...
let LineAnnotation = /*#__PURE__*/(() => {
  class LineAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_1__/* .Element */ .Hg {
    inRange(mouseX, mouseY, axis, useFinalPosition) {
    ...
    resolveElementProperties(chart, options) {
      ...
      if (options.curve) {
        ...
        properties.cp = getControlPoint(properties, options, (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.aF)(p1, p2));
      }
...
class EllipseAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_1__/* .Element */ .Hg {
  inRange(mouseX, mouseY, axis, useFinalPosition) {
    ...
    const rotatedPoint = rotated({
      x: mouseX,
      y: mouseY
    }, this.getCenterPoint(useFinalPosition), (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.t)(-rotation));
...
class PointAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_1__/* .Element */ .Hg {
  inRange(mouseX, mouseY, axis, useFinalPosition) {
    const {
      x,
      y,
...
class PolygonAnnotation extends chart_js__WEBPACK_IMPORTED_MODULE_1__/* .Element */ .Hg {
  inRange(mouseX, mouseY, axis, useFinalPosition) {
    if (axis !== 'x' && axis !== 'y') {
  ...
  resolveElementProperties(chart, options) {
    ...
    let rad = rotation * chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.b4;
...
function resolveAnimations(chart, animOpts, mode) {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_1__/* .Animations */ .Qw(chart, animOpts);
}
...
var annotation = {
  ...
  version,
  beforeRegister() {
    requireVersion('chart.js', '4.0', chart_js__WEBPACK_IMPORTED_MODULE_1__/* .Chart */ .t1.version);
  },
  afterRegister() {
    chart_js__WEBPACK_IMPORTED_MODULE_1__/* .Chart */ .t1.register(annotationTypes);
  },
  afterUnregister() {
    chart_js__WEBPACK_IMPORTED_MODULE_1__/* .Chart */ .t1.unregister(annotationTypes);
  },
  beforeInit(chart) {
