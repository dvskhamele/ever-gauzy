"use strict";
(self["webpackChunkgauzy"] = self["webpackChunkgauzy"] || []).push([[4102,7256],{
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   h: () => (/* binding */ TasksStoreService)
/* harmony export */ });
...
let TasksStoreService = /*#__PURE__*/(() => {
  class TasksStoreService {
    ...
    constructor(_taskService) {
      ...
      this.tasks$ = this._tasks$.asObservable().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__/* .map */ .T)(this._mapToViewModel));
    ...
    static {
      this.ɵfac = function TasksStoreService_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || TasksStoreService)(_angular_core__WEBPACK_IMPORTED_MODULE_3__/* ["ɵɵinject"] */ .KVO(_tasks_service__WEBPACK_IMPORTED_MODULE_4__/* .TasksService */ .w));
      };
    }
    static {
